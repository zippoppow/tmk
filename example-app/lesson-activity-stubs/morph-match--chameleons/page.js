...
export default function MorphMatchChameleonsPage() {
  return (
            ...
            <CardContent sx={{ p: 4 }}>
              ...
              >
                <Typography variant="body1">
                  <strong>Instructions:</strong> Based on your knowledge of the morpheme, match the correct chameleon and read the words..
                </Typography>
              </Paper>
