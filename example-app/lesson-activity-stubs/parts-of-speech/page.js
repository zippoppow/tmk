        ...
        <Container maxWidth="md">
          <Card sx={{ boxShadow: 3 }}>
            <CardContent sx={{ p: 4 }}>
              ...
              >
                LATIN PROGRESSION: PARTS OF SPEECH
              </Typography>
              ...
              >
                <Typography variant="body1">
                  <strong>Instructions:</strong> Sort words into their correct part of speech category. (hint: some could be more than one part of speech depending on the sentence)
                </Typography>
              </Paper>
