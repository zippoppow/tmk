...
export default function CreateWordListPage() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await fetchWithTmkToken('/api/word-lists', {
        method: 'POST',
        headers: {
        ...
        <Card sx={{ boxShadow: 3 }}>
          <CardContent sx={{ p: 4 }}>
            ...
            <Box sx={{ display: 'flex', justifyContent: 'center', mb: 2 }}>
              <Button component={Link} href="/utilities/view/word-list" variant="outlined" size="small">
                View Existing Word Lists
              </Button>
            </Box>
