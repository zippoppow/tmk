...
export default function CreateWordFamilyPage() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await fetchWithTmkToken('/api/word-families', {
        method: 'POST',
        headers: {
        ...
        <Card sx={{ boxShadow: 3 }}>
          <CardContent sx={{ p: 4 }}>
            ...
            <Box sx={{ display: 'flex', justifyContent: 'center', mb: 2 }}>
              <Button component={Link} href="/utilities/view/word-family" variant="outlined" size="small">
                View Existing Word Families
              </Button>
            </Box>
