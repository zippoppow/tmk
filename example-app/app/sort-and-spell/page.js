...
export default function SortAndSpellPage() {
  return (
            ...
            <CardContent sx={{ p: 4 }}>
              ...
              >
                <Typography variant="body1">
                  <strong>Instructions:</strong> Based on the spelling question, mark the appropriate Yes Cat or No Cat column. If Yes Cat, then, please spell the word.
                </Typography>
              </Paper>
