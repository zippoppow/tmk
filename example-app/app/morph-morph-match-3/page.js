...
export default function MorphMorphMatch3Page() {
  return (
            ...
            <CardContent sx={{ p: 4 }}>
              ...
              >
                <Typography variant="body1">
                  <strong>Instructions:</strong> Match the base word (i.e "tutor") to its related word (i.e. "tutorial") and sort it into the correct suffix category.
                </Typography>
              </Paper>
